                    ...
                    <form id="addPatient" action="profil-patient.php?idPatient=<?= $patients->id ?>" method="POST">
                                    ...
                                    <tbody>
                                        <?php foreach ($appointmentsList AS $appointment) { ?>
                                            <tr>
                                                ...
                                                <td><a href="rendezvous.php?idAppointment=<?= $appointment->id ?>"><i class="material-icons">folder</i></a></td>                                        
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <div class="row">
                            <div class="input-field col s12 center-align">
                                <input name="updateButton" type="submit" value="Enregistrer Modification(s)"/>
